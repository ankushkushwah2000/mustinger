      ...
      <div class="container">
        <div class="row py-4">
          <div class="col-md-5 border-ch p-4">
            ...
            @php
                $totalamout = $totalamout+($p->product_price*$p->quantity);
            @endphp
            @endforeach
            ...
            <div class="row">
              ...
              <div class="col-4">
                <p class="fw-bold text-black-l">Rs @php echo $totalamout @endphp</p>
              </div>
            </div>
            <div class="row">
              <div class="col-8">
              ...
              <div class="col-4">
                <p class="fw-bold text-black-l">Rs 300.00</p>
              </div>
            </div>
            <div class="row">
              <div class="col-8">
              ...
              <div class="col-4">
                <p class="fw-bold text-black-l">Rs 150.00</p>
              </div>
            </div>
            ...
            <div class="row fw-bold">
              ...
              <div class="col-4 ">
                <h5 class=" fw-bold c1-mm">Rs <?php echo $totalamout+300+150  ?></h5>
              </div>
            </div>
